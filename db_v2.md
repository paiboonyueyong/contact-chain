...
# Todo/Issue
   ...
   * แยก Card List ออกเป็นอีก Collection เพื่อให้ง่ายในการค้นหา //kelly
   * สร้าง QR Code สำหรับเก็บข้อมูลเบื้องต้นเพื่อใช้สำหรับการแลกเปลี่ยน Card แบบ Offline (เจอกันหน้าถ้ำไม่มีเน็ต) //Riya
   * เก็บข้อมูล Log การเข้าใช้งานระบบ
